...
if (isset($_REQUEST['btn_send'])) {
    try {
        ...
        } elseif ($department === 'revice_acc') {
            $path = 'acc/revice/' . $image_file;
        } else {
            // แผนกไม่ถูกต้อง
        ...
        if (!isset($errorMsg)) {
            ...
            if ($insert_stmt->execute()) {
                ...
                header("refresh:2;mk/index.php");  //เปลี่ยนของแผนกอื่น
            }
        }
    } catch (PDOException $e) {
        echo $e->getMessage();
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <select name="txt_department" class="form-control">
                ...
                <option value="revice_acc">บัญชี</option>
            </select>
        </div>
    </div>
</div>
    ...
    <div class="form-group">
        <div class="col-sm-12">
            ...
            <a href="mk/index.php" class="btn btn-danger">Cancel</a>        
        </div>
    </div>
</form>
