...
<?php
    ...
    if(isset($_REQUEST['delete_id'])){
        ...
        $delete_stmt = $db->prepare('DELETE FROM mk_doc WHERE id = :id');
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <?php                                           //เปลี่ยนของแผนกอื่นตรงนี้
                        $select_stmt = $db->prepare('SELECT * FROM mk_doc');
                        $select_stmt->execute();
                    ...
                    <tr>
                        ...
                        <td><a href="../send_mk.php?update_id=<?php echo $row['id']; ?>" class="btn btn-primary">Send</a></td>
